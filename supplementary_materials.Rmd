...
As we explain in the text, a way to deal with this problem is to fit a mixture model. We are going to stipulate that the bimodal distribution pictured above is a combination of two distributions. In this case, we choose two beta distributions, because they are bounded between 0 and 1, just like our data. 
